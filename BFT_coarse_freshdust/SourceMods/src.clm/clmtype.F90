...
type, public :: pft_dflux_type
   ...
   real(r8), pointer :: vlc_trb_5(:)            !turbulent deposition velocity 5(m/s)  ! JM
   real(r8), pointer :: vlc_trb_6(:)            !turbulent deposition velocity 6(m/s)  ! JM
   real(r8), pointer :: vlc_trb_7(:)            !turbulent deposition velocity 7(m/s)  ! JM
   real(r8), pointer :: vlc_trb_8(:)            !turbulent deposition velocity 8(m/s)  ! JM
...
!  real(r8), pointer :: xirrig(:)             !irrigation rate
   ...
   !JM add dst5-8
   !real(r8), pointer :: mss_dst5(:,:)         ! mass of dust species 1 in snow (col,lyr) [kg]
   !real(r8), pointer :: mss_dst6(:,:)         ! mass of dust species 2 in snow (col,lyr) [kg]
   !real(r8), pointer :: mss_dst7(:,:)         ! mass of dust species 3 in snow (col,lyr) [kg]
   !real(r8), pointer :: mss_dst8(:,:)         ! mass of dust species 4 in snow (col,lyr) [kg]
   ...
   !MJ add dst5-8
   !real(r8), pointer :: mss_cnc_dst5(:,:)     ! mass concentration of dust species 1 in snow (col,lyr) [kg/kg]
   !real(r8), pointer :: mss_cnc_dst6(:,:)     ! mass concentration of dust species 2 in snow (col,lyr) [kg/kg]
   !real(r8), pointer :: mss_cnc_dst7(:,:)     ! mass concentration of dust species 3 in snow (col,lyr) [kg/kg]
   !real(r8), pointer :: mss_cnc_dst8(:,:)     ! mass concentration of dust species 4 in snow (col,lyr) [kg/kg]
...
type, public :: column_wflux_type
   ...
   !MJ add dst5-8
   real(r8), pointer :: flx_dst_dep_dry5(:) ! dust species 1 dry deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_wet5(:) ! dust species 1 wet deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_dry6(:) ! dust species 2 dry deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_wet6(:) ! dust species 2 wet deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_dry7(:) ! dust species 3 dry deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_wet7(:) ! dust species 3 wet deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_dry8(:) ! dust species 4 dry deposition on ground (positive definite) (col) [kg/s]
   real(r8), pointer :: flx_dst_dep_wet8(:) ! dust species 4 wet deposition on ground (positive definite) (col) [kg/s]
