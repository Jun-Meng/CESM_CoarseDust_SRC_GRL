...
!-----------------------------------------------------------------------
   ...
   !JM add for DUST5-8
    call hist_addfld1d (fname='DPVLTRB5', units='m/s',  &
         avgflag='A', long_name='turbulent deposition velocity 5', &
         ptr_pft=pdf%vlc_trb_5, default='inactive')
    call hist_addfld1d (fname='DPVLTRB6', units='m/s',  &
         avgflag='A', long_name='turbulent deposition velocity 6', &
         ptr_pft=pdf%vlc_trb_6, default='inactive')
    call hist_addfld1d (fname='DPVLTRB7', units='m/s',  &
         avgflag='A', long_name='turbulent deposition velocity 7', &
         ptr_pft=pdf%vlc_trb_7, default='inactive')
    call hist_addfld1d (fname='DPVLTRB8', units='m/s',  &
         avgflag='A', long_name='turbulent deposition velocity 8', &
         ptr_pft=pdf%vlc_trb_8, default='inactive')
