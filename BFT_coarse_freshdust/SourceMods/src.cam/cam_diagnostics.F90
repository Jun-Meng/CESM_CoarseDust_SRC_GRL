...
subroutine diag_init()
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   call addfld('a2x_DSTWET5',  'kg/m2/s', 1, 'A', 'wetdep of dust (bin5)',                phys_decomp)  ! JM
   call addfld('a2x_DSTDRY5',  'kg/m2/s', 1, 'A', 'drydep of dust (bin5)',                phys_decomp)
   call addfld('a2x_DSTWET6',  'kg/m2/s', 1, 'A', 'wetdep of dust (bin6)',                phys_decomp)
   call addfld('a2x_DSTDRY6',  'kg/m2/s', 1, 'A', 'drydep of dust (bin6)',                phys_decomp)
   call addfld('a2x_DSTWET7',  'kg/m2/s', 1, 'A', 'wetdep of dust (bin7)',                phys_decomp)
   call addfld('a2x_DSTDRY7',  'kg/m2/s', 1, 'A', 'drydep of dust (bin7)',                phys_decomp)
   call addfld('a2x_DSTWET8',  'kg/m2/s', 1, 'A', 'wetdep of dust (bin8)',                phys_decomp)
   call addfld('a2x_DSTDRY8',  'kg/m2/s', 1, 'A', 'drydep of dust (bin8)',                phys_decomp)
   !---------------------------------------------------------
...
!-----------------------------------------------------------------------
   ...
   if (.not. atm_dep_flux) then
      ...
      cam_out%dstwet5  = 0.0_r8  ! JM
      cam_out%dstdry5  = 0.0_r8
      cam_out%dstwet6  = 0.0_r8
      cam_out%dstdry6  = 0.0_r8
      cam_out%dstwet7  = 0.0_r8
      cam_out%dstdry7  = 0.0_r8
      cam_out%dstwet8  = 0.0_r8
      cam_out%dstdry8  = 0.0_r8
   end if
   ...
   call outfld('a2x_DSTWET5',  cam_out%dstwet5,  pcols, lchnk)   !JM
   call outfld('a2x_DSTDRY5',  cam_out%dstdry5,  pcols, lchnk)
   call outfld('a2x_DSTWET6',  cam_out%dstwet6,  pcols, lchnk)
   call outfld('a2x_DSTDRY6',  cam_out%dstdry6,  pcols, lchnk)
   call outfld('a2x_DSTWET7',  cam_out%dstwet7,  pcols, lchnk)
   call outfld('a2x_DSTDRY7',  cam_out%dstdry7,  pcols, lchnk)
   call outfld('a2x_DSTWET8',  cam_out%dstwet8,  pcols, lchnk)
   call outfld('a2x_DSTDRY8',  cam_out%dstdry8,  pcols, lchnk)
