...
!------------------------------------------------------------------------
    ...
    allocate(pdf%vlc_trb_5(beg:end))  !JM
    allocate(pdf%vlc_trb_6(beg:end))  !JM
    allocate(pdf%vlc_trb_7(beg:end))  !JM
    allocate(pdf%vlc_trb_8(beg:end))  !JM
    ...
    pdf%vlc_trb_5(beg:end) = nan  !JM
    pdf%vlc_trb_6(beg:end) = nan  !JM
    pdf%vlc_trb_7(beg:end) = nan  !JM
    pdf%vlc_trb_8(beg:end) = nan  !JM
...
!   allocate(cps%xirrig(beg:end))
    ...
    !allocate(cps%mss_dst5(beg:end,-nlevsno+1:0))  !JM
    !allocate(cps%mss_dst6(beg:end,-nlevsno+1:0))  !
    !allocate(cps%mss_dst7(beg:end,-nlevsno+1:0))  !
    !allocate(cps%mss_dst8(beg:end,-nlevsno+1:0))  !
    ...
    !allocate(cps%mss_cnc_dst5(beg:end,-nlevsno+1:0)) !JM
    !allocate(cps%mss_cnc_dst6(beg:end,-nlevsno+1:0)) !JM
    !allocate(cps%mss_cnc_dst7(beg:end,-nlevsno+1:0))  !jm
    !allocate(cps%mss_cnc_dst8(beg:end,-nlevsno+1:0)) !JM
...
!   cps%xirrig(beg:end) = 0._r8
    ...
    !cps%mss_dst5(beg:end,-nlevsno+1:0) = nan  !JM
    !cps%mss_dst6(beg:end,-nlevsno+1:0) = nan  !
    !cps%mss_dst7(beg:end,-nlevsno+1:0) = nan  !
    !cps%mss_dst8(beg:end,-nlevsno+1:0) = nan  !
    ...
    !cps%mss_cnc_dst5(beg:end,-nlevsno+1:0) = nan  ! MJ
    !cps%mss_cnc_dst6(beg:end,-nlevsno+1:0) = nan  !
    !cps%mss_cnc_dst7(beg:end,-nlevsno+1:0) = nan  !
    !cps%mss_cnc_dst8(beg:end,-nlevsno+1:0) = nan  !
...
!------------------------------------------------------------------------
    ...
    !JM 
    allocate(cwf%flx_dst_dep_dry5(beg:end))
    allocate(cwf%flx_dst_dep_wet5(beg:end))
    allocate(cwf%flx_dst_dep_dry6(beg:end))
    allocate(cwf%flx_dst_dep_wet6(beg:end))
    allocate(cwf%flx_dst_dep_dry7(beg:end))
    allocate(cwf%flx_dst_dep_wet7(beg:end))
    allocate(cwf%flx_dst_dep_dry8(beg:end))
    allocate(cwf%flx_dst_dep_wet8(beg:end))
    ...
    !JM 
    cwf%flx_dst_dep_dry5(beg:end) = nan
    cwf%flx_dst_dep_wet5(beg:end) = nan
    cwf%flx_dst_dep_dry6(beg:end) = nan
    cwf%flx_dst_dep_wet6(beg:end) = nan
    cwf%flx_dst_dep_dry7(beg:end) = nan
    cwf%flx_dst_dep_wet7(beg:end) = nan
    cwf%flx_dst_dep_dry8(beg:end) = nan
    cwf%flx_dst_dep_wet8(beg:end) = nan
