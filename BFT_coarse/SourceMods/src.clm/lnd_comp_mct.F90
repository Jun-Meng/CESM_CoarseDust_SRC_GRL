...
!---------------------------------------------------------------------------
    ...
    do g = begg,endg
       ...
       if (index_l2x_Fall_flxdst5 /= 0 )  l2x_l%rAttr(index_l2x_Fall_flxdst5,i)= -clm_l2a%flxdst(g,5)
       if (index_l2x_Fall_flxdst6 /= 0 )  l2x_l%rAttr(index_l2x_Fall_flxdst6,i)= -clm_l2a%flxdst(g,6)
       if (index_l2x_Fall_flxdst7 /= 0 )  l2x_l%rAttr(index_l2x_Fall_flxdst7,i)= -clm_l2a%flxdst(g,7)
       if (index_l2x_Fall_flxdst8 /= 0 )  l2x_l%rAttr(index_l2x_Fall_flxdst8,i)= -clm_l2a%flxdst(g,8)
...
!---------------------------------------------------------------------------
    ...
    do g = begg,endg
        ...
        a2l%forc_aer(g,15)  =  x2l_l%rAttr(index_x2l_Faxa_dstwet5,i)
        a2l%forc_aer(g,16)  =  x2l_l%rAttr(index_x2l_Faxa_dstdry5,i)
        a2l%forc_aer(g,17)  =  x2l_l%rAttr(index_x2l_Faxa_dstwet6,i)
        a2l%forc_aer(g,18) =  x2l_l%rAttr(index_x2l_Faxa_dstdry6,i)
        a2l%forc_aer(g,19) =  x2l_l%rAttr(index_x2l_Faxa_dstwet7,i)
        a2l%forc_aer(g,20) =  x2l_l%rAttr(index_x2l_Faxa_dstdry7,i)
        a2l%forc_aer(g,21) =  x2l_l%rAttr(index_x2l_Faxa_dstwet8,i)
        a2l%forc_aer(g,22) =  x2l_l%rAttr(index_x2l_Faxa_dstdry8,i)
