...
!---------------------------------------------------------------------------------
  ...
  integer :: dust_indices(12)   ! JM  change from 8 to 12
...
!-----------------------------------------------------------------------
    ...
    ! JM add dst5-8
    call cnst_get_ind('DST05',dust_indices(5), abort=.false.)
    call cnst_get_ind('DST06',dust_indices(6), abort=.false.)
    call cnst_get_ind('DST07',dust_indices(7), abort=.false.)
    call cnst_get_ind('DST08',dust_indices(8), abort=.false.)
    ! MODAL aerosols
    call cnst_get_ind('dst_a1',dust_indices(9), abort=.false.)   !JM change from 5678 to 9 10 11 12
    call cnst_get_ind('dst_a3',dust_indices(10), abort=.false.)
    call cnst_get_ind('dst_a5',dust_indices(11), abort=.false.)
    call cnst_get_ind('dst_a7',dust_indices(12), abort=.false.)
