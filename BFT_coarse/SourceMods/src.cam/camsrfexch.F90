...
!---------------------------------------------------------------------------
  ...
  type cam_out_t 
     ...
     real(r8) :: dstwet5(pcols)      ! wet deposition of dust (bin5) !JM
     real(r8) :: dstdry5(pcols)      ! dry deposition of dust (bin5)
     real(r8) :: dstwet6(pcols)      ! wet deposition of dust (bin6)
     real(r8) :: dstdry6(pcols)      ! dry deposition of dust (bin6)
     real(r8) :: dstwet7(pcols)      ! wet deposition of dust (bin7)
     real(r8) :: dstdry7(pcols)      ! dry deposition of dust (bin7)
     real(r8) :: dstwet8(pcols)      ! wet deposition of dust (bin8)
     real(r8) :: dstdry8(pcols)      ! dry deposition of dust (bin8)
  end type cam_out_t 
...
!
    ...
    do c = begchunk,endchunk
       ...
       cam_out(c)%dstdry5(:)  = 0._r8  !JM
       cam_out(c)%dstwet5(:)  = 0._r8
       cam_out(c)%dstdry6(:)  = 0._r8
       cam_out(c)%dstwet6(:)  = 0._r8
       cam_out(c)%dstdry7(:)  = 0._r8
       cam_out(c)%dstwet7(:)  = 0._r8
       cam_out(c)%dstdry8(:)  = 0._r8
       cam_out(c)%dstwet8(:)  = 0._r8
    end do
