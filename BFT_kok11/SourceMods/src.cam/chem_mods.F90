...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 0, & ! number of photolysis reactions
                            ...
                            gas_pcnst = 20, & ! number of "gas phase" species, JM: from 16 to 20
                            nfs = 7, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 18, & ! number of non-zero matrix entries, JM: not sure, need revisit
                            ...
                            clscnt4 = 16, & ! number of species in implicit class, JM: from 16 to 20
