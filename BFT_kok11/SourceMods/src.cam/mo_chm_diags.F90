module mo_chm_diags
  ...
  integer :: aer_species(gas_pcnst), cam_aerosols(12)  !JM change from 8 to 12
...
contains
  ...
  subroutine chm_diags_inti
    ...
    ! JM add dst 5-8
    integer :: id_dst01, id_dst02, id_dst03, id_dst04, id_dst05, id_dst06, id_dst07, id_dst08, id_sslt01, id_sslt02, id_sslt03, id_sslt04
    ...
    integer :: bulkaero_species(24)  !JM change from 20 to 24
    ...
    !JM add dst 5-8
    id_dst05   = get_spc_ndx( 'DST05' )
    id_dst06   = get_spc_ndx( 'DST06' )
    id_dst07   = get_spc_ndx( 'DST07' )
    id_dst08   = get_spc_ndx( 'DST08' )
    ...
    bulkaero_species(:) = -1
    ! JM add dst5-8
    bulkaero_species(1:24) = (/ id_dst01, id_dst02, id_dst03, id_dst04, id_dst05, id_dst06, id_dst07, id_dst08, &
    ...
    enddo
    !JM add 5-8
    cam_aerosols = (/ id_dst01, id_dst02, id_dst03, id_dst04, id_dst05,id_dst06,id_dst07,id_dst08, &
                      id_sslt01, id_sslt02, id_sslt03, id_sslt04 /)
