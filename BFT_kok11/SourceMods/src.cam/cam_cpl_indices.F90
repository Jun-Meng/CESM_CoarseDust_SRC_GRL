module cam_cpl_indices
  ...
  integer :: index_a2x_Faxa_dstwet5    ! flux: Size 5 dust -- wet deposition   !JM
  integer :: index_a2x_Faxa_dstwet6    ! flux: Size 6 dust -- wet deposition
  integer :: index_a2x_Faxa_dstwet7    ! flux: Size 7 dust -- wet deposition
  integer :: index_a2x_Faxa_dstwet8    ! flux: Size 8 dust -- wet deposition
  integer :: index_a2x_Faxa_dstdry5    ! flux: Size 5 dust -- dry deposition
  integer :: index_a2x_Faxa_dstdry6    ! flux: Size 6 dust -- dry deposition
  integer :: index_a2x_Faxa_dstdry7    ! flux: Size 7 dust -- dry deposition
  integer :: index_a2x_Faxa_dstdry8    ! flux: Size 8 dust -- dry deposition
  ...
  integer :: index_x2a_Fall_flxdst5    ! dust flux size bin 5    !JM    
  integer :: index_x2a_Fall_flxdst6    ! dust flux size bin 6    
  integer :: index_x2a_Fall_flxdst7    ! dust flux size bin 7    
  integer :: index_x2a_Fall_flxdst8    ! dust flux size bin 8
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_x2a_Fall_flxdst5  = mct_avect_indexra(x2a,'Fall_flxdst5')  !JM
    index_x2a_Fall_flxdst6  = mct_avect_indexra(x2a,'Fall_flxdst6')
    index_x2a_Fall_flxdst7  = mct_avect_indexra(x2a,'Fall_flxdst7')
    index_x2a_Fall_flxdst8  = mct_avect_indexra(x2a,'Fall_flxdst8')
    ...
    index_a2x_Faxa_dstdry5  = mct_avect_indexra(a2x,'Faxa_dstdry5') !JM
    index_a2x_Faxa_dstdry6  = mct_avect_indexra(a2x,'Faxa_dstdry6') !
    index_a2x_Faxa_dstdry7  = mct_avect_indexra(a2x,'Faxa_dstdry7') !
    index_a2x_Faxa_dstdry8  = mct_avect_indexra(a2x,'Faxa_dstdry8') ! 
    ...
    index_a2x_Faxa_dstwet5  = mct_avect_indexra(a2x,'Faxa_dstwet5') !JM
    index_a2x_Faxa_dstwet6  = mct_avect_indexra(a2x,'Faxa_dstwet6') !
    index_a2x_Faxa_dstwet7  = mct_avect_indexra(a2x,'Faxa_dstwet7') !
    index_a2x_Faxa_dstwet8  = mct_avect_indexra(a2x,'Faxa_dstwet8') !
