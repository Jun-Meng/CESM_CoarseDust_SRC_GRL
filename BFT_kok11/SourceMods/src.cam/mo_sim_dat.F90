...
!--------------------------------------------------------------
      ...
      cls_rxt_cnt(:,4) = (/      0,     2,     0,    20 /)

      solsym(: 20) = (/ 'H2O2            ','SO2             ','SO4             ','DMS             ','OC1             ', &
                        'OC2             ','CB1             ','CB2             ','SSLT01          ','SSLT02          ', &
                        'SSLT03          ','SSLT04          ','DST01           ','DST02           ','DST03           ', &
                        'DST04           ','DST05           ','DST06           ','DST07           ','DST08           ' /)

      adv_mass(: 20) = (/    34.013600_r8,    64.064800_r8,    96.063600_r8,    62.132400_r8,    12.011000_r8, &
                            ...
                            135.064039_r8,   135.064039_r8,   135.064039_r8,   135.064039_r8,   135.064039_r8 /)
      ...
      clsmap(: 20,4) = (/    1,   2,   3,   4,   7,   8,   5,   6,   9,  10, &
      ...
      diag_map(: 16) = (/    1,   2,   3,   4,   5,   7,   8,  10,  11,  12, &
                            13,  14,  15,  16,  17,  18 /)      !JM not sure about the meaning of the numvers, need revisit
