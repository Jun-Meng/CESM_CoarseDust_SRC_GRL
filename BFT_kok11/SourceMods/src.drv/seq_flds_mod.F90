module seq_flds_mod
  ...
  !====================================================================
   ...
   character(CXX) :: seq_flds_s2x_states 
   character(CXX) :: seq_flds_s2x_fluxes 
   character(CXX) :: seq_flds_x2s_states 
   character(CXX) :: seq_flds_x2s_fluxes
   ...
   character(CXX) :: seq_flds_s2x_fields 
   character(CXX) :: seq_flds_x2s_fields 
...
! !INPUT/OUTPUT PARAMETERS:
     ...
     character(CXX) :: s2x_states = ''
     character(CXX) :: s2x_fluxes = ''
     character(CXX) :: x2s_states = ''
     character(CXX) :: x2s_fluxes = ''
...
!-------------------------------------------------------------------------------
     ...
     do n = 1,nfldmax
        if (cplflds_custom(n) /= ' ') then
           ...
           case('s2x')
              if (is_state) call seq_flds_add(s2x_states,trim(fldname))
              if (is_flux ) call seq_flds_add(s2x_fluxes,trim(fldname))
           case('x2s')
              if (is_state) call seq_flds_add(x2s_states,trim(fldname))
              if (is_flux ) call seq_flds_add(x2s_fluxes,trim(fldname))
           case default
     ...
     ! Size 5 dust -- wet deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstwet5"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstwet5"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstwet5"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstwet5"  )
     longname = 'Dust wet deposition flux (size 5)'
     stdname  = 'wet_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstwet5'
     call metadata_set(attname, longname, stdname, units)

     ! Size 6 dust -- wet deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstwet6"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstwet6"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstwet6"  )
    !  call seq_flds_add(x2o_fluxes,"Faxa_dstwet6"  )
     longname = 'Dust wet deposition flux (size 6)'
     stdname  = 'wet_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstwet6'
     call metadata_set(attname, longname, stdname, units)

     ! Size 7 dust -- wet deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstwet7"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstwet7"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstwet7"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstwet7"  )
     longname = 'Dust wet deposition flux (size 7)'
     stdname  = 'wet_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstwet7'
     call metadata_set(attname, longname, stdname, units)

     ! Size 8 dust -- wet deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstwet8"  )
   !  call seq_flds_add(x2i_fluxes,"Faxa_dstwet8"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstwet8"  )
   !  call seq_flds_add(x2o_fluxes,"Faxa_dstwet8"  )
     longname = 'Dust wet deposition flux (size 8)'
     stdname  = 'wet_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstwet8'
     call metadata_set(attname, longname, stdname, units)
     ...
     ! Size 5 dust -- dry deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstdry5"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstdry5"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstdry5"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstdry5"  )
     longname = 'Dust dry deposition flux (size 5)'
     stdname  = 'dry_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstdry5'
     call metadata_set(attname, longname, stdname, units)

     ! Size 6 dust -- dry deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstdry6"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstdry6"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstdry6"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstdry6"  )
     longname = 'Dust dry deposition flux (size 6)'
     stdname  = 'dry_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstdry6'
     call metadata_set(attname, longname, stdname, units)
 
     ! Size 7 dust -- dry deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstdry7"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstdry7"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstdry7"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstdry7"  )
     longname = 'Dust dry deposition flux (size 7)'
     stdname  = 'dry_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstdry7'
     call metadata_set(attname, longname, stdname, units)

     ! Size 8 dust -- dry deposition JM add dst5-8 
     call seq_flds_add(a2x_fluxes,"Faxa_dstdry8"  )
    ! call seq_flds_add(x2i_fluxes,"Faxa_dstdry8"  )
     call seq_flds_add(x2l_fluxes,"Faxa_dstdry8"  )
    ! call seq_flds_add(x2o_fluxes,"Faxa_dstdry8"  )
     longname = 'Dust dry deposition flux (size 8)'
     stdname  = 'dry_deposition_flux_of_dust'
     units    = 'kg m-2 s-1'
     attname  = 'Faxa_dstdry8'
     call metadata_set(attname, longname, stdname, units)
     !----------------------------------------------------------
     ...
     ! Dust flux (particle bin number 5)  JM add dst5-8 
     call seq_flds_add(l2x_fluxes,"Fall_flxdst5")
     call seq_flds_add(x2a_fluxes,"Fall_flxdst5")
     longname = 'Dust flux (particle bin number 5)'
     stdname  = 'dust_flux'
     units    = 'kg m-2 s-1'
     attname  = 'Fall_flxdst5'
     call metadata_set(attname, longname, stdname, units)
 
     ! Dust flux (particle bin number 6)  JM add dst5-8 
     call seq_flds_add(l2x_fluxes,"Fall_flxdst6")
     call seq_flds_add(x2a_fluxes,"Fall_flxdst6")
     longname = 'Dust flux (particle bin number 6)'
     stdname  = 'dust_flux'
     units    = 'kg m-2 s-1'
     attname  = 'Fall_flxdst6'
     call metadata_set(attname, longname, stdname, units)

     ! Dust flux (particle bin number 7)  JM add dst5-8 
     call seq_flds_add(l2x_fluxes,"Fall_flxdst7")
     call seq_flds_add(x2a_fluxes,"Fall_flxdst7")
     longname = 'Dust flux (particle bin number 7)'
     stdname  = 'dust_flux'
     units    = 'kg m-2 s-1'
     attname  = 'Fall_flxdst7'
     call metadata_set(attname, longname, stdname, units)

     ! Dust flux (particle bin number 8)  JM add dst5-8 
     call seq_flds_add(l2x_fluxes,"Fall_flxdst8")
     call seq_flds_add(x2a_fluxes,"Fall_flxdst8")
     longname = 'Dust flux (particle bin number 8)'
     stdname  = 'dust_flux'
     units    = 'kg m-2 s-1'
     attname  = 'Fall_flxdst8'
     call metadata_set(attname, longname, stdname, units)
     !-----------------------------
     ...
     call seq_flds_add(l2x_fluxes,'Flrl_rofliq')
     call seq_flds_add(x2r_fluxes,'Flrl_rofliq')
     ...
     call seq_flds_add(l2x_fluxes,'Flrl_rofice')
     call seq_flds_add(x2r_fluxes,'Flrl_rofice')
     ...
     call seq_flds_add(r2x_fluxes,'Forr_roff')
     call seq_flds_add(x2o_fluxes,'Forr_roff')
     ...
     call seq_flds_add(r2x_fluxes,'Forr_ioff')
     call seq_flds_add(x2o_fluxes,'Forr_ioff')
     ...
     call seq_flds_add(r2x_states,'Slrr_volr')
     call seq_flds_add(x2l_states,'Slrr_volr')
     ...
     do num = 1,seq_flds_glc_nec
        ...
        stdname  = 'height'
        units    = 'm'
        attname  = 'Ss_topo' // cnum
        call metadata_set(attname, longname, stdname, units)

        name = 'Fgss_qice' // cnum
        call seq_flds_add(s2x_fluxes,trim(name))
        ...
        call seq_flds_add(x2s_states,trim(name))
        ...
        call seq_flds_add(x2s_fluxes,trim(name))
        longname = 'Ice runoff flux of elevation class ' // cnum
        stdname  = 'ice_runoff_flux_in_glacier'
        units    = 'kg m-2 s-1'
        attname  = 'Fsgg_rofi' // cnum
        call metadata_set(attname, longname, stdname, units)

        name = 'Fsgg_rofl' // cnum
        call seq_flds_add(g2x_fluxes,trim(name))
        call seq_flds_add(x2s_fluxes,trim(name))
        longname = 'Liquid runoff flux of elevation class ' // cnum
        stdname  = 'liquid_runoff_flux_in_glacier'
        units    = 'kg m-2 s-1'
        attname  = 'Fsgg_rofl' // cnum
        call metadata_set(attname, longname, stdname, units)
     ...
     seq_flds_s2x_states = trim(s2x_states)
     seq_flds_x2s_states = trim(x2s_states)
     ...
     seq_flds_s2x_fluxes = trim(s2x_fluxes)
     seq_flds_x2s_fluxes = trim(x2s_fluxes)
     ...
     if (seq_comm_iamroot(ID)) then
        ...
        write(6,"(A)")'seq_flds_mod: seq_flds_s2x_states= ',trim(seq_flds_s2x_states)
        write(6,"(A)")'seq_flds_mod: seq_flds_s2x_fluxes= ',trim(seq_flds_s2x_fluxes)
        write(6,"(A)")'seq_flds_mod: seq_flds_x2s_states= ',trim(seq_flds_x2s_states)
        write(6,"(A)")'seq_flds_mod: seq_flds_x2s_fluxes= ',trim(seq_flds_x2s_fluxes)
     ...
     call catFields(seq_flds_s2x_fields, seq_flds_s2x_states, seq_flds_s2x_fluxes)
     call catFields(seq_flds_x2s_fields, seq_flds_x2s_states, seq_flds_x2s_fluxes)
