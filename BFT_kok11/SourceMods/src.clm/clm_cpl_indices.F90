...
!
  ...
  integer, public ::index_l2x_Fall_flxdst5    ! dust flux size bin 5    
  integer, public ::index_l2x_Fall_flxdst6    ! dust flux size bin 6    
  integer, public ::index_l2x_Fall_flxdst7    ! dust flux size bin 7    
  integer, public ::index_l2x_Fall_flxdst8    ! dust flux size bin 8
  ...
  integer, public ::index_x2l_Faxa_dstwet5    ! flux: Size 5 dust -- wet deposition  !JM
  integer, public ::index_x2l_Faxa_dstwet6    ! flux: Size 6 dust -- wet deposition
  integer, public ::index_x2l_Faxa_dstwet7    ! flux: Size 7 dust -- wet deposition
  integer, public ::index_x2l_Faxa_dstwet8    ! flux: Size 8 dust -- wet deposition
  integer, public ::index_x2l_Faxa_dstdry5    ! flux: Size 5 dust -- dry deposition
  integer, public ::index_x2l_Faxa_dstdry6    ! flux: Size 6 dust -- dry deposition
  integer, public ::index_x2l_Faxa_dstdry7    ! flux: Size 7 dust -- dry deposition
  integer, public ::index_x2l_Faxa_dstdry8    ! flux: Size 8 dust -- dry deposition
...
!-----------------------------------------------------------------------
    ...
    index_l2x_Fall_flxdst5  = mct_avect_indexra(l2x,'Fall_flxdst5')  !JM
    index_l2x_Fall_flxdst6  = mct_avect_indexra(l2x,'Fall_flxdst6')
    index_l2x_Fall_flxdst7  = mct_avect_indexra(l2x,'Fall_flxdst7')
    index_l2x_Fall_flxdst8  = mct_avect_indexra(l2x,'Fall_flxdst8')
    ...
    index_x2l_Faxa_dstdry5  = mct_avect_indexra(x2l,'Faxa_dstdry5')
    index_x2l_Faxa_dstdry6  = mct_avect_indexra(x2l,'Faxa_dstdry6')
    index_x2l_Faxa_dstdry7  = mct_avect_indexra(x2l,'Faxa_dstdry7')
    index_x2l_Faxa_dstdry8  = mct_avect_indexra(x2l,'Faxa_dstdry8')
    index_x2l_Faxa_dstwet5  = mct_avect_indexra(x2l,'Faxa_dstwet5')
    index_x2l_Faxa_dstwet6  = mct_avect_indexra(x2l,'Faxa_dstwet6')
    index_x2l_Faxa_dstwet7  = mct_avect_indexra(x2l,'Faxa_dstwet7')
    index_x2l_Faxa_dstwet8  = mct_avect_indexra(x2l,'Faxa_dstwet8')
